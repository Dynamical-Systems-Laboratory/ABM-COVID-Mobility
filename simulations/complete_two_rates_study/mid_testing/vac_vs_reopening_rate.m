...
max_clr = [0.41,0.05,0.49];
% Number of colors to use (lowest is white)
clr_points = 20;

plot_title = 'Total deaths';
ylimits = [0,150];
clevels = [10, 20, 50, 70, 100];
cb_ticks = [0, 50, 100, 150];
cb_tick_labels = {'0', '50', '100', '150'};
...
ylimits = [0,30000];
clevels = [2500, 5000, 10000, 20000, 25000];
cb_ticks = [0, 0.5e4, 1e4, 1.5e4, 2e4, 2.5e4, 3e4];
% cb_tick_labels = {'0', '5,000', '10,000', '15,000', '20,000', '25,000', '30,000', '35,000'};
% These are actually x10^4
cb_tick_labels = {'0', '0.5', '1', '1.5', '2', '2.5', '3'};
