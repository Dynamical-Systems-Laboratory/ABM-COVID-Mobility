...
n_rh = 5
n_schools = 68
# This needs to be updated every time new data arrives
# from town creation procedure because these are created
# based on random distributions/assignments 
n_carpools = 1335
n_public = 14
# Number of initially infected - if from file
n_inf0 = 1321
